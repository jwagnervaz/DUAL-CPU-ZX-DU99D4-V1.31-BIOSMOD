...
4 - REBAR support integraded - OPTIONAL, if you dont enable with Rebar.exe it will be turned off (credits to https://github.com/xCuri0/ReBarUEFI) so for use this function you need a GPU compatible and use xCuri0 application to set rebar size) 

5 - C6 Retention Enabled

6 - ME UPDATED TO 9.1.45.3000 (Latest provided by intel desktop chipset)
...
12 - BIOS updated to (05/06/2023)ZX-DU99D4 V1.3
thanks to dump provided by https://github.com/leiskris
